...
const adminNavItems = [
  ...
  { path: '/admin/channels', label: 'Channels', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v1m0-1v-1m-2 3c.281 0 .54.133.798.353l.707.707a1 1 0 001.414 0l.707-.707c.258-.22.517-.353.798-.353M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
];
...
<Link
          to="/admin/categories"
          className="p-6 bg-bg-secondary rounded-xl hover:bg-bg-tertiary transition-colors"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-lg bg-green-500/20 flex items-center justify-center">
              <svg className="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4zM11 11v5a1 1 0 002 0v-5a1 1 0 00-2 0z" />
              </svg>
            </div>
            <div>
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-lg bg-red-500/20 flex items-center justify-center">
              <svg className="w-6 h-6 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v1m0-1v-1m-2 3c.281 0 .54.133.798.353l.707.707a1 1 0 001.414 0l.707-.707c.258-.22.517-.353.798-.353M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <div>
              <h3 className="font-heading font-semibold text-text-primary">Channels</h3>
              <p className="text-text-muted text-sm">YouTube channels</p>
            </div>
          </div>
        </Link>
      </div>
